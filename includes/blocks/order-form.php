    ...
    <form id="mos-order-form" class="mos-order-form" enctype="multipart/form-data" method="post">
      ...
      <div class="order-form-group" data-id="0">
        ...
        <div class="order-form-block order-form-block-10">
          ...
          <input type="number" class="order-form-quantity order-form-input" name="quantity-0" min="1" required max="100" value="1">
        </div>
      ...
      <div class="order-form-add-group">
        <button type="button" id="order-form-add" class="form-subscribe-button form-subscribe-button-secondary" data-id="0">Adaugă un fișier</button>
        <div class="small-text">Fișiere permise: pdf, geo, dxf, step, stp, jpg, png</div>
