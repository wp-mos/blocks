          ...
          <form id="mos-order-form" class="mos-order-form" enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-wrapper">
                          ...
                          <div class="form-block-body">
                              <label class="form-label form-subscribe-button" for="fileToUpload">
                                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                      ...
                                      <path d="M15 9C15 13.5 14.3333 15.75 9 15.75C3.66667 15.75 3 13.5 3 9C3 4.5 3.75 2.25 9 2.25C14.25 2.25 15 4.5 15 9Z"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M6.75 3C6.75 3 7.20343 4.79657 6.375 5.625C5.54657 6.45343 3.75 6 3.75 6"
                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                      <path d="M6.75 9.75H11.25M9 12L9 7.5" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"/>
                                  </svg>
                                  Upload DXF File</label>
                              <input type="file" id="fileToUpload" class="form-control form-file" name="fileToUpload"
                                     data-id="0" required="">
                          </div>
                      </div>
                      ...
                      <div class="form-block form-block-select-material disabled">
                          ...
                          <div class="form-block-body">
                              ...
                              <select id="material" class="form-select form-material" name="material" required=""
                                      data-id="1">
                      ...
                      <div class="form-block form-block-quantity disabled">
                          ...
                          <div class="form-block-body">
                              <input type="number" class="form-control form-quantity form-input" name="quantity"
              ...
              <div class="form-submit hide">
                  <div class="form-submit-wrapper">
                      <input class="form-submit-button form-subscribe-button hide" type="submit"
