  ...
  <div class="wp-block-mos-blocks-login-form">
    ...
    <form id="login-form" class="login-form" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" id="login-form-email" name="login-form-email" class="form-input" placeholder="<?php esc_attr_e('Email', 'text-domain'); ?>" value="<?php echo isset($_POST['login-form-email']) ? esc_attr($_POST['login-form-email']) : ''; ?>" />
      </div>

      <div class="form-group">
        <label for="login-form-password"><?php esc_html_e('Parola', 'text-domain'); ?></label>
        <input type="password" id="login-form-password" name="login-form-password" class="form-input" placeholder="<?php esc_attr_e('Parola', 'text-domain'); ?>" />
      </div>

      <div class="form-footer">
        <div class="form-footer-meta">
          <?php esc_html_e('Nu ai inca cont?', 'text-domain'); ?>
          <a class="animated-link" href="<?php echo esc_url(site_url('/utilizatori/inregistrare')); ?>"><?php esc_html_e('Inregistreza-te', 'text-domain'); ?></a>
        </div>
        <button class="form-subscribe-button" type="submit"><?php esc_html_e('Intră în cont', 'text-domain'); ?></button>
      </div>
